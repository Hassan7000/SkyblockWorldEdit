package me.enchantbook.skyblockworldedit.Nbt.utils.nmsmappings;
    ...
    ObjectCreator(MinecraftVersion from, MinecraftVersion to, Class<?> clazz, Class<?>... args){
       ...
       if(to != null && MinecraftVersion.getVersion().getVersionId() > to.getVersionId())
    	...
    	try{
            ...
            SkyblockWorldEdit.getInstance().getLogger().log(Level.SEVERE, "Unable to find the constructor for the class '" + clazz.getName() + "'", ex);
        }
    }
